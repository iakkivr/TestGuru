...
class FeedbacksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create feedback" do
    assert_difference('Feedback.count') do
      post feedbacks_url, params: { feedback: { body: @feedback.body, email: @feedback.email, resolved: @feedback.resolved } }
    end
  ...
  test "should update feedback" do
    patch feedback_url(@feedback), params: { feedback: { body: @feedback.body, email: @feedback.email, resolved: @feedback.resolved } }
